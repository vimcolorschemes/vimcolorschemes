    ...
    <>
      ...
      <main className={styles.container}>
        ...
        <p>
          ...
          colorschemes the focal point of every page. Speed and accessibility
          are also part of the core mission of vimcolorschemes.
        </p>
        ...
        <blockquote>
          Note: The words can be in any order. Example:{' '}
