  ...
  return (
    <Layout>
      <SEO
        ...
        description={`The ${name} vim color scheme was created ${format(createdAt)} years ago by ${ownerName}, and has over ${stargazersCount} stars on Github. Check it out on vimcolorschemes.com!`}
