...
test("getFirstProcessedFluidImage with valid featured image and empty images", () => {
  ...
  expect(getFirstProcessedFluidImage(validProcessedFluidImage, [])).toBe(
    expectedFluidImage,
  );
  expect(getFirstProcessedFluidImage(validProcessedFluidImage, null)).toBe(
    expectedFluidImage,
  );
});
...
test("getFirstProcessedFluidImage with invalid featured image and valid images", () => {
  ...
  expect(getFirstProcessedFluidImage(null, [closeImageCopy])).toBe(
    expectedFluidImage,
  );
  expect(getFirstProcessedFluidImage({}, [closeImageCopy])).toBe(
    expectedFluidImage,
  );
  expect(
